...
//#include "Przejściowy.h"

// Ten plik jest nieużywany w aplikacji
...
namespace Obydzialal {
	...
	public:
		...
		//{
			...
			//
		//}
		PrzygotowanieForm(Form^ obj1223)
		{
			obj1233 = obj1223;
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Load += gcnew System::EventHandler(this, &PrzygotowanieForm::PrzygotowanieForm_Load);
...
#pragma endregion
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		//Przejściowy^ objprzej = gcnew Przejściowy();
		//objprzej->ShowDialog();
	...
	private: System::Void PrzygotowanieForm_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	};
}
